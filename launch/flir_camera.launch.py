...
def launch_setup(context, *args, **kwargs):
    ...
    node = Node(
        ...
        parameters=[
            ...
            {
                # "camera.image_raw.ffmpeg.encoding": "hevc_nvenc",
                "camera.image_raw.ffmpeg.encoding": "h264_vaapi",
                # "camera.image_raw.ffmpeg.encoding": "libx264",
                "camera.image_raw.ffmpeg.profile": "main",
                "camera.image_raw.ffmpeg.bit_rate": 0,
                "camera.image_raw.ffmpeg.crf": "0",
                "camera.image_raw.ffmpeg.gop_size": 0,
                "camera.image_raw.ffmpeg.pixel_format": "yuv420p",
